...
a persistence unit "parqueaderoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "parqueadero\pom.xml":
...
artifact ("parqueadero.war") is already built. You can build
